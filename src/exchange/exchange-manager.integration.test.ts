...
describe("exchange-manager (integration)", () => {
  ...
  describe("integration with getEnabledExchanges", () => {
    ...
    it("should return consistent results after multiple operations", () => {
      ...
      const batch1 = [exchangeManager.getEnabledExchanges().size, exchangeManager.getStatus()];

      const batch2 = [exchangeManager.getEnabledExchanges().size, exchangeManager.getStatus()];
