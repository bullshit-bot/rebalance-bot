...
export const STRATEGY_PRESETS = {
  ...
  VolatilityAdjusted: {
    description:
      "Dynamic threshold scales with market volatility — trades less in calm, more in storms",
    params: {
      type: "vol-adjusted",
      minTradeUsd: 15,
      baseThresholdPct: 5,
  ...
  TrendProtected: {
    description:
      "MA100 trend filter — sells to 70% cash in bear, DCA routing in bull. Best 5yr: +141%",
    params: { type: "threshold", thresholdPct: 15, minTradeUsd: 10 },
    globalSettings: {
      cashReservePct: 10,
      dcaRebalanceEnabled: true,
