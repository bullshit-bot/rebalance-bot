...
export type NewRebalance = Omit<IRebalance, 'totalTrades' | 'totalFeesUsd' | 'startedAt' | 'completedAt' | 'afterState' | 'errorMessage'> & {
  totalTrades?: number; totalFeesUsd?: number; startedAt?: Date; completedAt?: Date | null; afterState?: Record<string, unknown> | null; errorMessage?: string | null
}
