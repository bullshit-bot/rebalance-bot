...
describe('order-executor (integration)', () => {
  ...
  describe('execute method - error handling', () => {
    it('throws when exchange not found after MAX_RETRIES', async () => {
      const order = {
  ...
  describe('executeBatch with single order', () => {
    it('handles batch with one order', async () => {
      const orders = [
        {
          exchange: 'binance' as const,
          pair: 'ETH/USDT',
    ...
    it('executeBatch continues on error', async () => {
      const orders = [
        {
          exchange: 'binance' as const,
          pair: 'BTC/USDT',
  ...
  describe('execute with no price cache', () => {
    it('fails when no price available', async () => {
      const order = {
        exchange: 'binance' as const,
        pair: 'UNKNOWN/PAIR',
        side: 'buy' as const,
